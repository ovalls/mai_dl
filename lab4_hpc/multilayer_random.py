...
with tf.Session() as sess:
  ...
  for i in range(1000):
    ...
    # Option 1: from random number, take batch size images (50)
    r = int(N.random.uniform(1, 50000-batch_size))
    ...
    # Option 1
    batch_ini = r
    batch_end = r + batch_size

    # Default Option and Option 1
    ...
    if i % 10 == 0:
      ...
      acc_list_tr.append(train_accuracy)
...
print('acc_list_tr: {}'.format(acc_list_tr))
